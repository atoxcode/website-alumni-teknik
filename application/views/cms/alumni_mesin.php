    ...
    <div class="page-header" id="banner">
      <div class="row">
        <div class="col-md-12" align="center">
          <h1>Daftar Alumni Teknik Mesin</h1>
          <p class="lead">Fakultas Teknik - Universitas Malikussaleh</p>
          </br><br>
          
          <div class="col-md-4">
            <form method="post" action="<?php echo base_url().'index/alumni_mesin' ?>" enctype="multipart/form-data">
              <h5>Tahun Masuk:</h5>
            ...
            <?php foreach($alumni_mesin as $p){ ?>
            <table width="15%" style="background-color: #30C39E;" class="table table-bordered" id="table-datatable">
