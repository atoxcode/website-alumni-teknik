    ...
    <div class="page-header" id="banner">
      <div class="row">
        <div class="col-md-12" align="center">
          <h1>Daftar Alumni Teknik Arsitektur</h1>
          <p class="lead">Fakultas Teknik - Universitas Malikussaleh</p>
          </br><br>
          
          <div class="col-md-4">
            <form method="post" action="<?php echo base_url().'index/alumni_arsitektur' ?>" enctype="multipart/form-data">
              <h5>Tahun Masuk:</h5>
          ...
          <div class="col-md-12">
            <?php foreach($alumni_arsitektur as $p){ ?>
